...
<div >
  ...
  <form action="sherlock_upload.php" method="post" enctype="multipart/form-data">
  ...
  <div class="input-group">
      ...
      <input type="radio" name="type" class="form-control" id="type" value="S" checked>Sherlock
	  <input type="radio" name="type" class="form-control" id="type" value="W" >Watcher
