...
// Check if entry already exists
    $checkquery = "SELECT * FROM sherlock_questions WHERE level=$level AND qno=$qno";
...
if($uploadOk==1){
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["imgfile"]["tmp_name"], $target_file)) {
            $insquery="INSERT INTO sherlock_questions(level,qno,question,answer,type,image) VALUES ('$level','$qno','$question','$ans','$type','$target_file');";
        }
    }
}
...
/* All except image entry */
    ...
    $insquery="INSERT INTO sherlock_questions(level,qno,question,answer) VALUES ('$level','$qno','$question','$ans');";
